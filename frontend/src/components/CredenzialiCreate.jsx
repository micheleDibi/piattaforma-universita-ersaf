  ...
  return (
    <div className={contenutoPagina("modulo")}>
      <div className={`${scheda()} max-w-lg w-full p-8`}>
        <h2 className="text-xl font-bold text-testo mb-2">{titolo} creato</h2>
        ...
        <dl className="rounded-superficie border border-attenzione-bordo bg-attenzione-tenue p-5 mb-6">
          <dt className="text-nota font-bold tracking-wide text-attenzione-forte">USERNAME</dt>
          <dd className="font-mono text-base text-testo-forte mb-4 select-all break-all">{credenziali.username}</dd>
          <dt className="text-nota font-bold tracking-wide text-attenzione-forte">PASSWORD</dt>
