...
export default function ModuloOtp({ iniziale, operazioni, onVerificato, onAnnulla }) {
  ...
  return (
    <form className={stili.modulo} aria-busy={otp.occupato}
      ...
      {otp.sfida ? <>
        <p className={stili.nota}>Codice inviato a {otp.sfida.destinatario}. È valido per 10 minuti.</p>
        <div>
        ...
        <button type="button" className={pulsante("secondario", "grande", { larghezzaPiena: true })}
