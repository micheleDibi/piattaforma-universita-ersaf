...
class Cliente(Base):
    ...
    cliente_CAP:Mapped[int] = mapped_column(Integer, nullable=False)
    ...
    cliente_CAPDomicilio:Mapped[int] = mapped_column(Integer, nullable=True)
    cliente_provinciaDomicilio:Mapped[str] = mapped_column(String(2), nullable=True)
    cliente_ruolo:Mapped[int] = mapped_column(ForeignKey("ruoli.ruolo_id"))
    cliente_gg: Mapped[int]= mapped_column(Integer, nullable=True)
    attuatore_id: Mapped[int]= mapped_column(Integer, nullable=True)
    azienda_id: Mapped[int]= mapped_column(Integer, nullable=True)
    tessera_id: Mapped[int]= mapped_column(Integer, nullable=True)
    cliente_abilPraticheUniv: Mapped[int]= mapped_column(Integer, nullable=False)
    cliente_pathCertificato: Mapped[str]= mapped_column(String, nullable=True)
    cliente_abilitazione_ecampus: Mapped[int]= mapped_column(Integer, nullable=False)
    cliente_abilitazione_link_campus: Mapped[int]= mapped_column(Integer, nullable=False)
    cliente_abilitazione_corsi_speciali: Mapped[int]= mapped_column(Integer, nullable=False)
    cliente_abilitazione_a4u: Mapped[int]= mapped_column(Integer, nullable=False)
